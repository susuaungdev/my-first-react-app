              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    disabled={loading}
                    className="w-full rounded-xl border border-slate-300 bg-slate-50/40 px-4 py-3 pr-16 text-sm text-slate-900 outline-none transition placeholder:text-slate-400 hover:border-slate-400 focus:border-blue-500 focus:bg-white focus:ring-4 focus:ring-blue-100 disabled:cursor-not-allowed disabled:opacity-60"
                  />
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="absolute inset-y-0 right-0 px-4 text-xs font-semibold text-blue-600 transition hover:text-blue-700 disabled:cursor-not-allowed disabled:opacity-60"
