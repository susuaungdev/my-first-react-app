          ...
          <div className="mb-7 flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
            ...
            <div className="max-w-2xl">
              ...
              <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-500">
                Create, manage, and update your professional resumes in one place.
              </p>
            ...
            <div className="grid w-full grid-cols-1 gap-2 sm:w-auto sm:grid-cols-2">
              ...
              <button
                ...
                className="inline-flex w-full items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-700 shadow-sm transition hover:border-blue-200 hover:bg-blue-50 hover:text-blue-700 sm:w-auto"
              >
                <svg
                  viewBox="0 0 24 24"
                  className="h-4 w-4"
          ...
          <section className="mb-7">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <button
                ...
                className="group flex items-start gap-4 rounded-2xl border border-slate-200 bg-white p-5 text-left shadow-sm transition hover:border-blue-200 hover:shadow-md"
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="mt-1.5 text-sm leading-6 text-slate-500">
                    Use guided sections and ready-made professional layouts.
                  </p>
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="mt-1.5 text-sm leading-6 text-slate-500">
                    Create your own layout with drag, resize, colors, and custom positioning.
                  </p>
